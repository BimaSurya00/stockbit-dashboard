...
/* Controls */
.controls-bar { display: flex; gap: 20px; margin-bottom: 28px; }
...
.sector-select {
  height: 44px; width: 220px; flex-shrink: 0; padding: 0 42px 0 16px;
  border: 1px solid var(--border); border-radius: 100px; background: var(--surface);
  font-family: 'Inter', sans-serif; font-size: 14px; font-weight: 500; color: var(--text);
  outline: none; cursor: pointer; transition: var(--transition); box-sizing: border-box;
